...
def _build_prompt_state(state: dict) -> dict:
    ...
    prompt_state.setdefault("rag_context", state.get("rag_context", ""))
    prompt_state.setdefault("rag_query", state.get("rag_query", ""))
    prompt_state.setdefault("rag_search_type", state.get("rag_search_type", ""))
    return prompt_state
