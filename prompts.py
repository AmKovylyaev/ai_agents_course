...
STEP_JUDGE_PROMPT = """You are a Senior Data Scientist (Judge). Your task is to evaluate the results of a Machine Learning experiment for a Kaggle competition: predicting occupancy days (or idle days) for real estate rentals. This is a regression task; the evaluation metric is MSE (Mean Squared Error).
